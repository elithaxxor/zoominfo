    ...
    if counter_00 == index_end:  ## break
        ...
        def bs_req(key):
            try:
                ...
                print(f'[SYSTEM] -- [{counter_00}] Parsing Bs-Request With New Payload [{counter_00}] [SYSTEM]'.center(
                    width))
                payload = {}
        ...
        def run_downloader(key):
            ...
            if (key.find(website)) != -1:
                ...
                try:
                    ...
                    with open('torrent_downloader.html', "a") as f:
                        ...
                        t_name_list = soup.find(
                            class_='col-9 page-content')  # class ing-table - mau have to change between
                        ...
                        if len(i_torrent_link) > 0:
                            try:
                                print(
                                    f'[SYSTEM]** [{counter_00}] Connecting To TORRENT SERVER  [{counter_00}] ...\n '.center(
                                        width))
                                time.sleep(1)
                                ...
                                print(
                                    f'[SYSTEM]** [{counter_00}] TORRENT PARSE COMPLETE, MOVING TO DOWNLOAD  [{counter_00}] ...\n '.center(
                                        width))
            ...
            #################################################################################
                ...
                print(
                    f'[SYS] [{counter_00}] No Torrents Found, Continuing To Parse, then moving on to download[{counter_00}] '.center(
                        width))
                try:  # w/header
                    start_time = time.time()
                    ...
                    print(
                        f'[SYSTEM]** [{counter_00}] Connecting To Server. Sleeping for 5 seconds [{counter_00}'.center(
                            width))
                    print()
                    print(
                        f'ARCHIVE.ORG may take longer than normal DO NOT QUITE PROGRAM, IT WILL RETURN ERROR CODE IF PARSING ERROR.'.center(
                            width))
                    print()
                    time.sleep(1)
                    URL = key
                ...
                if path:
                    ...
                    if parsed == 'True':  ###
                        try:
                            ...
                            print()
                            print(
                                f'[SYSTEM][{counter_00}] -- {cyan} RUNNING TORRENT DOWNLOADER {reset}-- [{counter_00}] [SYSTEM] '.center(
                                    width))
                            ...
                            print(
                                f'[SYSTEM]--[{counter_00}] ** {cyan}  DOWNLOAD COMPLETE {reset} ** [{counter_00}]--'.center(
                                    width))
                            loop += 1
                            break
                        ...
                        try:
                            print(
                                f'[SYSTEM][{counter_00}] -- {cyan} RUNNING FILE GRABBER {reset} -- [{counter_00}] [SYSTEM] '.center(
                                    width))
                            download_file = download(to_connect)
                            print(
                                f'[SYSTEM][{counter_00}] -- {cyan} {DOWNLOAD_NAME} COMPLETE {reset} -- [{counter_00}] [SYSTEM] '.center(
                                    width))
                            print('****', DOWNLOAD_LOC)
                            loop += 1
                            # pass
