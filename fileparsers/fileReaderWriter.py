    ...
    ########################################################################################
        ...
        if (r.status_code == 200):
            try:
                ...
                game_name_list = soup.find(
                    class_='download-directory-listing')  ##### <--------  USE / CHANGE LATER FOR BETTER RESULTS
...
rom_dict = {'GENESIS': 'https://archive.org/download/SegaGenesisMegaDriveRomCollectionByGhostware',
            'SATURN': 'https://archive.org/download/SegaSaturnRomCollectionByGhostware',
            'DREAMCAST': 'https://archive.org/download/DreamcastCollectionByGhostwareMulti-region',
            'NES': 'https://archive.org/download/NintendoMultiRomCollectionByGhostware',
            'SNES': 'https://archive.org/download/SuperNintendoUSACollectionByGhostware'}
